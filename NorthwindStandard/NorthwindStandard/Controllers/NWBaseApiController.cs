...
namespace NorWnd.API.Controllers.NW
{
	...
	[RoutePrefix("api/NW")]
	public abstract partial class NWBaseApiController : ApiController, ILoggingService
	{
		private ILoggingService _log;
		private INWRepository _repository;

		public NWBaseApiController()
		{
			try
			{
				_log = new CodeGenHero.EAMVCXamPOCO.Service.Log4NetLoggingService();

				_repository = new NWRepository(
					new Repository.Entities.NW.NWDataContext());
		...
		public NWBaseApiController(ILoggingService log, INWRepository repository)
		{
		...
		protected INWRepository Repo { get { return _repository; } }
